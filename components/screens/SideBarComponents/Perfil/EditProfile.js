...
import { View, Text, TouchableOpacity, SafeAreaView, TextInput, ScrollView, Alert, BackHandler } from 'react-native';
...
import { validarUsername, validarEmail, validarPassword } from '../../../../utils';
        ...
        <ScrollView style={{ flex: 1, width: '100%' }} contentContainerStyle={{ alignItems: 'center' }} showsVerticalScrollIndicator={false}>
            ...
            <View style={stylesEditPerfil.buttonsContainer}>
                <TouchableOpacity 
                    ...
                    onPress={() => {dataToEditProfile(username, email, password)}}
                >
