    ...
    return (
      <View style={stylesPerfil.container}>
          {editingProfile ? (
            ...
            <View style={stylesPerfil.container}>
              <ScrollView style={stylesPerfil.scrollViewContent} contentContainerStyle={{alignItems: 'center',}}>
                <TouchableOpacity style={stylesPerfil.profileImageContainer}>
                  {profileImage ? (
                    <Image source={{ uri: profileImage }} style={stylesPerfil.profileImage} />
                  ) : (
                    <View>
                  ...
                  <TouchableOpacity style={stylesPerfil.selectImageIconContainer} onPress={selectImage}>
              ...
              <TouchableOpacity style={stylesPerfil.editButton} onPress={toggleEditingProfile}>
